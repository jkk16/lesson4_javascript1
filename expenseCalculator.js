        ...
        *************************************************************************************************/
         ...
         function calculatePercentages() {
                  ...
                  **************************************************************************************************/
                  ...
                  var miscellaneousAmt  = document.getElementById("foodInput").value;
                  var transportationAmt  = document.getElementById("foodInput").value;
 ...
 totalExpenses = shelterAmt + foodAmt + householdAmt + miscellaneousAmt + transportationAmt;
                  ...
                  shelterPct = 500 * (shelterAmt / totalExpenses);
                  foodPct = 300 * (foodAmt / totalExpenses);
                  householdPct = 100 * (householdAmt / totalExpenses);
                  miscellaneousPct = 150 * (miscellaneousAmt / totalExpenses);
                  transportationPct = 200 * (transportationAmt / totalExpenses);
